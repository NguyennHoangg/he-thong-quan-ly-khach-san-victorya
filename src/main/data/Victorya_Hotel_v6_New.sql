...
CREATE TABLE ChiTietPhieuDatPhong (
    ...
    CONSTRAINT CK_ChiTietPhieuDatPhong_Time CHECK (
...
CREATE TABLE KhuyenMai (
    ...
    CONSTRAINT CK_KhuyenMai_HeSo CHECK (
        heSo >= 0
        AND heSo <= 1
    )
);
...
CREATE
INDEX IX_CaLamViecNhanVien_MaNhanVien ON CaLamViecNhanVien (maNhanVien);
...
CREATE
INDEX IX_PhieuDatPhong_MaKhachHang ON PhieuDatPhong (maKhachHang);
...
CREATE
INDEX IX_ChiTietPhieuDatPhong_MaPhieuDatPhong ON ChiTietPhieuDatPhong (maPhieuDatPhong);

CREATE
INDEX IX_ChiTietPhieuDatPhong_MaPhong ON ChiTietPhieuDatPhong (maPhong);

CREATE
INDEX IX_ChiTietPhieuDatPhong_ThoiGianNhanPhong ON ChiTietPhieuDatPhong (thoiGianNhanPhong);

CREATE
INDEX IX_ChiTietPhieuDatPhong_ThoiGianTraPhong ON ChiTietPhieuDatPhong (thoiGianTraPhong);
...
VALUES (
        'admin',
        '$2a$10$9eypGo00I/fQB.j2X0ZyB.adLUV9/Kj/Mt8RUziE6UoFwTCYd.Ivi',
        'admin'
    ), -- mk: admin
    (
        '0365271958',
        '$2a$10$Wzi1CNeJidRvX5Q4SRdbneW0VZmk1T1i6mrv1Hh7vIi6OMQdGwu..',
        'employee'
    );
-- mk: hoang@123H
...
VALUES (
        ...
        1,
        '2004-08-27',
        'nguyenhuyhoang270804@gmail.com',
        '0901234567',
        '2020-01-10',
        'admin',
        N'Đang làm việc',
        N'477/42 Nguyễn Văn Công, Gò Vấp'
    ),
    (
        'NV002',
        '012345678910',
...
-- 3. Ca làm việc
INSERT INTO
    Ca (maCa, ngayBatDau, ngayKetThuc)
VALUES (
        'CA-20251020-1',
        '2025-10-20',
        '2025-10-20'
...
VALUES (
    ...
    (
        ...
        N'Dịch vụ đặc biệt',
        500000,
        N'Dịch vụ đặc biệt cho phòng VIP',
        N'Lượt'
    );

-- 6. DichVu_LoaiPhong (CHỈ PHÒNG VIP CÓ DỊCH VỤ)
INSERT INTO
    DichVu_LoaiPhong (maDichVu, maLoaiPhong)
VALUES ('DV-12345', 'LP02'),
    ('DV-23456', 'LP02'),
    ('DV-34567', 'LP02'),
    ('DV-45678', 'LP02'),
    ('DV-56789', 'LP02'),
...
VALUES (
        'KM-0001',
        N'Giảm 10% cho hóa đơn trên 1 triệu',
        '2025-10-01 00:00:00',
        '2025-10-31 23:59:59',
        'Đang áp dụng',
        0.10,
    ...
    (
        'KM-0002',
        N'Giảm 15% cho hóa đơn trên 2 triệu',
        '2025-10-01 00:00:00',
        '2025-10-31 23:59:59',
        'Đang áp dụng',
        0.15,
    ...
    (
        'KM-0003',
        N'Giảm 20% cho hóa đơn trên 5 triệu',
        '2025-10-01 00:00:00',
        '2025-10-31 23:59:59',
        'Đang áp dụng',
        0.20,
...
VALUES (
        'KH011',
        'P-0006',
        N'Phòng sạch sẽ, thoáng mát. Nhân viên nhiệt tình. Sẽ quay lại!',
        '2025-10-19 13:00:00'
    ),
    (
        'KH012',
        'P-0001',
        N'Giá cả hợp lý, dịch vụ tốt. Hài lòng với trải nghiệm.',
        '2025-10-19 21:00:00'
    ),
    (
        'KH013',
        'P-0031',
        N'Phòng VIP rất đẹp, dịch vụ 5 sao. Đáng đồng tiền!',
        '2025-10-20 13:00:00'
    ),
    (
        'KH014',
        'P-0017',
        N'Phòng hơi nhỏ nhưng tiện nghi đầy đủ, wifi nhanh.',
        '2025-10-20 23:00:00'
    ),
    (
        'KH015',
        'P-0009',
        N'Nhân viên nhiệt tình, phòng đẹp. Sẽ giới thiệu bạn bè.',
        '2025-10-21 13:00:00'
    );
