...
public class NhanPhong_GUI extends BorderPane {
    ...
    private void hienThiThongTinKhachHang(KhachHang khachHang) {
        try {
            ...
            // Thông tin cơ bản hiển thị bên phải
            ...
            containerThongTinKhachHang.getChildren().addAll(infoBox, btnXemChiTiet);
                ...
                try {
                    ...
                    for (ChiTietPhieuDatPhong ctpdp : danhSachPhongChoNhan) {
                        ...
                        try {
                            ...
                            danhSachPhongChoNhanData
                                    .add(new RoomCheckInRow(soPhong, thoiGianNhan, thoiGianCho, ctpdp));
                        } catch (Exception e) {
    ...
    /**
     * Tính thời gian chờ còn lại tính đến thời điểm cuối cùng có thể nhận
     * (thoiGianNhanPhong + 6 giờ)
     * Ví dụ: Phòng có thoiGianNhanPhong = 14:00, hiện tại = 15:00, thì còn 5 giờ
     * đến 20:00
     */
    ...
    /**
     * Xác định trạng thái nhận phòng: "Sẵn sàng nhận", "Chưa đến thời gian nhận",
     * "Quá thời gian nhận"
     * Trạng thái "Sẵn sàng nhận" khi: (thoiGianNhanPhong - 1 giờ) <= thời điểm hiện
     * tại <= (thoiGianNhanPhong + 6 giờ)
    ...
    public static class RoomCheckInRow {
        ...
        public RoomCheckInRow(String soPhong, String thoiGianNhanPhong, String thoiGianCho,
