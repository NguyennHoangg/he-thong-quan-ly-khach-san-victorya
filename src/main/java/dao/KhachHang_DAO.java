    ...
    public class KhachHang_DAO {
        ...
        /** Đếm số khách hàng MỚI được tạo trong THÁNG HIỆN TẠI (dựa vào cột ngayTao) */
        public int countKhachHangMoiThangNay() {
            LocalDate homNay = LocalDate.now();
            int year = homNay.getYear();
            int month = homNay.getMonthValue();
