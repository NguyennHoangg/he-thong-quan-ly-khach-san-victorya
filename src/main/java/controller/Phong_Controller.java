...
public class Phong_Controller {
    ...
    public List<Phong> getPhongTheoTrangThaiVaLoaiPhong(String trangThai, String loaiPhong) {
        List<Phong> dsPhong = phong_DAO.getPhongTheoTrangThaiVaLoaiPhong(trangThai, loaiPhong);
     ...
     */
    public List<Phong> getDsachPhongTrongTheoThoiGian(String tenLoaiPhong, String thoiGianCheckIn,
     ...
     */
    public List<Phong> goiYPhongPhuHop(String thoiGianCheckIn, String thoiGianCheckOut, String tenLoaiPhong,
            int soNguoiLon, int soTreEm) {

        // Lấy danh sách phòng trống theo thời gian
        List<Phong> dsPhongTrong = phong_DAO.timKiemPhongTrongTheoThoiGian(tenLoaiPhong, thoiGianCheckIn,
                thoiGianCheckOut);
     ...
     * VD: 7 người lớn, 4 trẻ em → Gợi ý: 1 phòng gia đình (8 người) + 1 phòng đôi
     * (4 người)
     */
    public List<Phong> timToHopPhongToiUu(List<Phong> dsPhongTrong, int soNguoiLon, int soTreEm) {
        ...
        // Tạo bản sao và SẮP XẾP theo ưu tiên: Gia đình → Đôi → Đơn, sau đó theo sức
        // chứa cao → thấp
    ...
    public List<Phong> locPhong(String trangThai, int tang) {
